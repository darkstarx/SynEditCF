...
const
  ...
  ecOffsetCaret     = 18;   // Move cursor to current caret + offset, Data = PBufferCoord
  ecGotoMatchPair   = 19;   // Move cursor to matching pairing element
  ecGotoMatchFoPair = 20;   // Move cursor to matching folding pairing element
