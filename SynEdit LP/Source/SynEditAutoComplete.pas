...
type
  ...
  public
    ...
    function Execute(AEditor: TCustomSynEdit): Boolean; virtual;
    function ExecuteCompletion(const AToken: UnicodeString; AEditor: TCustomSynEdit): Boolean;
      virtual;
...
function TCustomSynAutoComplete.Execute(AEditor: TCustomSynEdit): Boolean;
var
  s: UnicodeString;
  i, j: integer;
begin
  ...
  begin
    ...
    begin
      ...
      Inc(i);
      s := Copy(s, i, j - i);
      Result := ExecuteCompletion(s, AEditor);
    end;
  end;
end;

function TCustomSynAutoComplete.ExecuteCompletion(const AToken: UnicodeString;
  AEditor: TCustomSynEdit): Boolean;
var
    ...
    begin
      ...
      try
        ...
        try
          ...
          begin
            s := UnicodeString(StringOfChar(' ', IndentLen));
