...
type
  ...
  public
    ...
    function Replace(const aOccurrence, aReplacement: UnicodeString; Index: Integer): UnicodeString; override;        //slm 11/29/02
  end;
...
function TSynEditWildcardSearch.Replace(const aOccurrence, aReplacement: UnicodeString; Index: Integer): UnicodeString;
begin
  Result := inherited Replace(aOccurrence, aReplacement, Index);
end;   
