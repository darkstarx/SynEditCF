(*
  ...
  Provides support for complex scripts through Microsoft Uniscribe.

  Initial author: Microsoft.
  Translation of header: Alexey Barkovoy.
  Dynamic linking logic: Maël Hörz.

  Copyright 2008-2010, initial authors
*)
...
const
  ...
  SCRIPT_UNDEFINED  = 0;
  //
  //      SCRIPT_UNDEFINED: This is the only public script ordinal. May be
  ...
  USP_E_SCRIPT_NOT_IN_FONT = DWord((SEVERITY_ERROR shl 31) or
                             (FACILITY_ITF shl 16)) or
                             $200; // MAKE_HRESULT(SEVERITY_ERROR,FACILITY_ITF,0x200)
