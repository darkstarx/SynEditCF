...
// PASTLWTR : 1.2
// File generated on 8/7/2002 1:39:14 PM from Type Library described below.
...
const
  ...
  // Missing constants
  CGID_IWebBrowser: TGUID = '{ED016940-BD5B-11CF-BA4E-00C04FD70816}';
  HTMLID_FIND       = 1;
  HTMLID_VIEWSOURCE = 2;
  HTMLID_OPTIONS    = 3;
...
// *********************************************************************//
  TWebBrowser_V1BeforeNavigate = procedure(ASender: TObject; const URL: WideString; Flags: Integer; 
                                                             const TargetFrameName: WideString; 
                                                             var PostData: OleVariant; 
                                                             const Headers: WideString; 
                                                             var Cancel: WordBool) of object;
  TWebBrowser_V1NavigateComplete = procedure(ASender: TObject; const URL: WideString) of object;
  TWebBrowser_V1StatusTextChange = procedure(ASender: TObject; const Text: WideString) of object;
  TWebBrowser_V1ProgressChange = procedure(ASender: TObject; Progress: Integer; ProgressMax: Integer) of object;
  TWebBrowser_V1CommandStateChange = procedure(ASender: TObject; Command: Integer; Enable: WordBool) of object;
  TWebBrowser_V1NewWindow = procedure(ASender: TObject; const URL: WideString; Flags: Integer; 
                                                        const TargetFrameName: WideString; 
                                                        var PostData: OleVariant; 
                                                        const Headers: WideString; 
                                                        var Processed: WordBool) of object;
  TWebBrowser_V1TitleChange = procedure(ASender: TObject; const Text: WideString) of object;
  TWebBrowser_V1FrameBeforeNavigate = procedure(ASender: TObject; const URL: WideString; 
                                                                  Flags: Integer; 
                                                                  const TargetFrameName: WideString; 
                                                                  var PostData: OleVariant; 
                                                                  const Headers: WideString; 
                                                                  var Cancel: WordBool) of object;
  TWebBrowser_V1FrameNavigateComplete = procedure(ASender: TObject; const URL: WideString) of object;
  TWebBrowser_V1FrameNewWindow = procedure(ASender: TObject; const URL: WideString; Flags: Integer; 
                                                             const TargetFrameName: WideString; 
                                                             var PostData: OleVariant; 
                                                             const Headers: WideString; 
                                                             var Processed: WordBool) of object;
  TWebBrowser_V1Quit = procedure(ASender: TObject; var Cancel: WordBool) of object;
  TWebBrowser_V1PropertyChange = procedure(ASender: TObject; const Property_: WideString) of object;
...
// *********************************************************************//
  ...
  TInternetExplorerFileDownload = procedure(ASender: TObject; var Cancel: WordBool) of object;
...
procedure TWebBrowser_V1.Navigate(const URL: WideString; const Flags: OleVariant);
begin
...
begin
  case DispID of
    ...
    270: if Assigned(FOnFileDownload) then
         FOnFileDownload(Self, WordBool((TVarData(Params[0]).VPointer)^) {var WordBool});
...
{procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TWebBrowser_V1, TWebBrowser]);
  RegisterComponents(dtlServerPage, [TInternetExplorer, TShellWindows, TShellUIHelper, TShellNameSpace]);
end;}
